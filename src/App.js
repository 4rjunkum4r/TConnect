    ...
    return (
        <nav className="navbar navbar-custom navbar-expand-md">
            <div className="container-fluid">
                <a className="navbar-brand" href="#"><img src={Logo} className="nav-brand-img align-top rounded" alt="T Connect Logo" /></a>
                ...
                <div className="navbar-collapse collapse position-relative" id="navbar">
                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item mx-1">
                            <button className="btn btn-success nav-item-custom" type="submit">Search</button>
                        </li>
                            ...
                            <div className="container">
                                <div className="row ">
                                    <div className="col-auto me-auto">
                                        <button className="btn btn-profile btn-primary" id="emailButton">Write E-mail</button>
                                    </div>
                                    <div className="col-auto">
                                        <button className="btn btn-profile btn-primary" id="bookAnAppointment">Book An Appointment</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="modal-dialog" role="document">
                            <div className="modal-content clearfix">
                                <div className="modal-body">
                                    ...
                                    <p className="description">If you are new here just register with your Registration Number & Password</p>
...
function YourProfile() {
    return (
        <div className="container">
            <img className="yp" src="https://www.focusedu.org/wp-content/uploads/2018/12/circled-user-male-skin-type-1-2.png" alt=""></img>
        </div>
